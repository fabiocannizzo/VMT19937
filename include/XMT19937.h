...
private:
    ...
    void NO_INLINE refill()
    {
        ...
        stCur = advanceLoop(r1, stCur, x0, 1, M, s_refillMasks, std::make_integer_sequence<int, r1>{});
        ...
        stCur = advanceLoop(r2, stCur, x0, 1, M - N, s_refillMasks, std::make_integer_sequence<int, r2>{});
