Model: MT19937 (32-bit)
State Size: 19,937 bits

This directory contains jump-ahead data for the 32-bit Mersenne Twister generator.
...
Naming: `J<N>.mt32.bits` represents a jump of 2^N steps.
Usage: These masks are used by the new `PolynomialJumpApplier` and are the default for VMT19937.
