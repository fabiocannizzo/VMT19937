...
void demo128()
{
    ...
    /*
        ...
        Use the following jump matrices, depending on the chosen number of bits :
            32 = > nullptr
            128 = > ./dat/mt32/F19935.bits
            256 = > ./dat/mt32/F19934.bits
            512 = > ./dat/mt32/F19933.bits
    ...
    */
    using jump_matrix_t = MT19937Matrix<32>;

    jump_matrix_t*jumpMatrix = new jump_matrix_t(std::string("./dat/mt32/F19935.bits"));
    ...
    */
    jump_matrix_t*commonJumpMatrix = nullptr;
...
void demoParallel()
{
    ...
    const jump_matrix_t* jumpMatrix = new jump_matrix_t(std::string("./dat/mt32/F19935.bits"));
    ...
    const jump_matrix_t* commonJumpMatrix = new jump_matrix_t(std::string("./dat/mt32/F00100.bits"));
