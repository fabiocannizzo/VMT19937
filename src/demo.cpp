...
void demo128()
{
    ...
    */
    MT19937Matrix *jumpMatrix = new MT19937Matrix(std::string("./dat/mt32/F19935.bits"));
...
void demoParallel()
{
    ...
    const MT19937Matrix* jumpMatrix = new MT19937Matrix(std::string("./dat/mt32/F19935.bits"));
    ...
    const MT19937Matrix* commonJumpMatrix = new MT19937Matrix(std::string("./dat/mt32/F00100.bits"));
