...
void demo128()
{
    ...
    /*
        ...
        Use the following masks, depending on the chosen number of bits :
            32 = > nullptr
            128 = > ./dat/poly/mt32/J19935.mt32.bits
            256 = > ./dat/poly/mt32/J19934.mt32.bits
            512 = > ./dat/poly/mt32/J19933.mt32.bits
    ...
    */
    ...
    poly_t jumpPoly;
    std::ifstream is("./dat/poly/mt32/J19935.mt32.bits", std::ios::binary);
...
void demoParallel()
{
    ...
    poly_t commonPoly;
    std::ifstream isC("./dat/poly/mt32/J00100.mt32.bits", std::ios::binary);
...
void demoVMT64()
{
    ...
    /*
        ...
        Number of states by VecLen:
            128 => 2 states, use ./dat/poly/mt64/J19936.mt64.bits
    ...
    */
    ...
    poly_t jumpPoly;
    std::ifstream is("./dat/poly/mt64/J19936.mt64.bits", std::ios::binary);
    if (is) jumpPoly.fromBin(is);
