...
void demo128()
{
    ...
    /*
        ...
        Use the following jump matrices, depending on the chosen number of bits :
            32 = > nullptr
            128 = > ./dat/mt/F19935.bits
            256 = > ./dat/mt/F19934.bits
            512 = > ./dat/mt/F19933.bits
    ...
    */
    MT19937Matrix *jumpMatrix = new MT19937Matrix(std::string("./dat/mt/F19935.bits"));
...
void demoParallel()
{
    ...
    const MT19937Matrix* jumpMatrix = new MT19937Matrix(std::string("./dat/mt/F19935.bits"));
    ...
    const MT19937Matrix* commonJumpMatrix = new MT19937Matrix(std::string("./dat/mt/F00100.bits"));
